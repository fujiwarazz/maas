    ...
    def innovation_bad_agent(state: AgentState):
        ...
        if research_info and research_body:
            ...
            **可供分析的历史辩论消息**: {past_memory_str}
            ...
            feasbile_bad_his.append(argument)
            ...
            origin_debate_results = state.get("debate_results", {}) or {}
            new_debate_results = dict(origin_debate_results)

            current_discussion = dict(new_debate_results.get(_curr, {}))
            current_discussion["创新性"] = new_innovation_bad_debate_state
            new_debate_results[_curr] = current_discussion
